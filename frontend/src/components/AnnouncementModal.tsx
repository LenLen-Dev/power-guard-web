...
export function AnnouncementModal({ open, onClose, onDismissForWeek }: AnnouncementModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/35 p-3 backdrop-blur-sm [-webkit-overflow-scrolling:touch] sm:p-4">
      <div className="flex min-h-full items-start justify-center py-2 sm:items-center sm:py-4">
        <div
          className="flex w-full max-w-4xl flex-col overflow-hidden rounded-[32px] border border-sky-100 bg-white shadow-[0_35px_90px_rgba(15,23,42,0.2)]"
          style={{ maxHeight: "calc(100vh - 1.5rem)" }}
        >
          <div className="shrink-0 bg-[radial-gradient(circle_at_top_left,_rgba(125,211,252,0.45),_transparent_42%),linear-gradient(135deg,_#eff6ff,_#ffffff_58%,_#ecfeff)] px-5 py-5 sm:px-8 sm:py-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h3 className="mt-4 text-2xl font-black tracking-tight text-slate-900 sm:text-3xl">提醒系统正在悄悄升级中</h3>
                ...
                <div className="mt-5 inline-flex max-w-2xl items-center gap-3 rounded-[22px] border border-rose-200 bg-rose-50/90 px-4 py-3 text-left shadow-sm sm:px-5 sm:py-4">
          ...
          <div className="custom-scrollbar flex-1 overflow-y-auto px-5 py-5 [-webkit-overflow-scrolling:touch] sm:px-8 sm:py-6">
            <div className="grid gap-5 md:grid-cols-[1fr_1.08fr]">
              <div className="rounded-[28px] border border-amber-100 bg-[linear-gradient(180deg,_rgba(255,251,235,0.95),_rgba(255,255,255,0.96))] p-5 sm:p-6">
              ...
              <div className="rounded-[28px] border border-emerald-100 bg-[linear-gradient(180deg,_rgba(236,253,245,0.95),_rgba(255,255,255,0.98))] p-5 sm:p-6">
          ...
          <div className="shrink-0 flex flex-col-reverse gap-3 border-t border-slate-100 px-5 py-4 sm:flex-row sm:items-center sm:justify-end sm:px-8 sm:py-5">
